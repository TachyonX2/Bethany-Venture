...
const services = [
  ...
  },
  {
    ...
    description: 'Provide strategic guidance on fundraising strategy, valuation, OTC, Market making, Exchange Listing,and investor relations to maximize funding success.',
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
